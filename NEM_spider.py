...
class NEM_spider(object):
    ...
    def get_playlist_detail(self,playlist_id):   #获取歌单信息
    ...
    def from_playlist_get_song_list(self,playlist_id):   #提取整合信息
    ...
    def get_artists_songlist(self,artist_id):  #测试单个歌手用
    ...
    def get_song_lyric(self, song_id):  #
        ...
        payload = {       #获取歌词必要参数  lv格式 kv ??? tv 是否搜索tlyric格式
        'os':'pc',
        'id': song_id,
        'lv': -1,
        'kv': -1,
    ...
    def get_song_comments(self,song_id,limit=100,offset=0,total='false'):  #获取评论 默认一百
...
if __name__ == '__main__':
    spider = NEM_spider()
    #playlist_id=input("Please enter the list's ID...")
